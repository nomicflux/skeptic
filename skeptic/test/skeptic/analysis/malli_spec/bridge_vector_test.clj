...
(deftest vector-of-int-imports-as-empty-prefix-int-tail
  (is (= (at/->SeqT tp (at/pattern-from-prefix-tail [] (at/->GroundT tp :int 'Int)) :vector)
...
(deftest vector-of-maybe-int-imports-with-maybe-tail
  (is (= (at/->SeqT tp (at/pattern-from-prefix-tail [] (at/->MaybeT tp (at/->GroundT tp :int 'Int))) :vector)
