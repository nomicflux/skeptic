(ns skeptic.core-cljs-test
  ...
  each finding. `--cljs-disable` filters .cljs files at discovery and
  collapses .cljc to a `:clj`-only pass. Reuses the Phase 7 p7 fixture."
...
(deftest cljs-disable-flag-parses
  (let [{:keys [options]} (opts/parse ["--cljs-disable"])]
